...
const candleColors = ['#FFD700', '#FFB6C1', '#87CEEB', '#FF00FF', '#00FF00']
const balloonColors = ['#FF00FF', '#FFD700', '#FFB6C1', '#00FF00', '#87CEEB']
      ...
      >
        ...
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-black">
          ...
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-2xl font-semibold text-gray-600">Muhammad Haris Awan</CardDescription>
            <p className="text-lg text-gray-500">Hope all your birthday wishes come true.</p>
          </CardHeader>
